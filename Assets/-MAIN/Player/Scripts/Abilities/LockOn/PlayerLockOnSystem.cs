...
public class PlayerLockOnSystem : PlayerPassive
{
    [Header("Aiming")]
    ...
    void Update()
    {
        ...
        {
            endLocation = Vector3.Lerp(endLocation, object_CurrentLockOnTarget.position, Time.deltaTime * 10f);
    ...
    void TryFindTarget()
    {
        ...
        for (int i = 0; i < numTargets; i++)
        {
            ...
            if (collider.TryGetComponent(out PlayerLockOnObject lockOnScript))
            {
